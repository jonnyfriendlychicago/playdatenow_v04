...
<div id="playdateCard" class="card p-3 d-md-flex justify-content-start">
	<div id="creatorOrganizerTopButton"
		...
		<!-- end creatorOrganizer -->

		<a href="/playdate/${playdate.id}"><button
				class="btn btn-secondary mb-2">Cancel</button></a>
	</div>
	<!-- end creatorOrganizerTopButton -->

	<form:form action='/playdate/edit' method='post'
		...
		<div id="eventDeetsAndRsvpRow" class="row mt-3">
			<div id="playdateInfoCol" class="col">
				...
				<div class="form-floating mb-3">
					<form:select path="eventStatus" class="form-control"
						id="eventStatus" placeholder="eventStatus">
				...
				<div class="form-floating mb-3">
					...
					<div id="eventNameHelp" class="form-text">If left blank, your
						event will be listed as "Playdate." Suggestion: enter a
						descriptive name (e.g., arts & crafts, bike ride, scooters, legos,
						etc.).</div>
					<p class="text-danger">
				...
				<div class="form-floating mb-3">
					<form:input path="locationName" type="text" class="form-control"
						id="locationName" placeholder="locationName" />
					<form:label path="locationName" for="locationName">Location Name</form:label>
					<div id="locationHelp" class="form-text">Examples: Our Home
						or Central Park or Gertie's Ice Cream, etc.</div>
					<p class="text-danger">
					<p class="text-danger">
				...
				<div class="form-floating mb-3">
					<form:input path="eventDate" type="date" class="form-control"
						id="eventDate" placeholder="eventDate" />
				...
				<div class="form-floating mb-3">
					<form:select path="startTimeTxt" class="form-control"
						id="startTimeTxt" placeholder="startTimeTxt">
					...
					<p class="text-danger">
						<form:errors path="startTimeTxt" />
				</div>


				<div class="form-floating mb-3">
					<form:input path="locationAddy" type="text" class="form-control"
						id="locationAddy" placeholder="locationAddy" />
					<form:label path="locationAddy" for="locationAddy">Location Address</form:label>
					<p class="text-danger">
						<form:errors path="locationAddy" />
				</div>

				<div class="form-floating mb-3">
					<form:textarea path="eventDescription" type="eventDescription"
						class="form-control" id="eventDescription"
						placeholder="eventDescription" style="height: 10rem;" />
				...
				<div class="form-floating mb-3">
					<form:input path="maxCountKids" type="number" class="form-control"
						id="maxCountKids" placeholder="maxCountKids" min="1" step="1" />
					<form:label path="maxCountKids" for="maxCountKids">Max. Kids Number</form:label>
					<p class="text-danger">
						<form:errors path="maxCountKids" />
				</div>
			</div>
			<!-- end playdateInfoCol -->
			...
			<div id="rsvpEtcCol" class="col">
				<div id="rsvpTrackingCard"
					...
					<table
						class="table table-responsive mt-2 table-borderless table-sm">
	...
	<div id="rsvpListRow" class="row m-1">
		...
		<div id="otherActionsCard"
			class="card mt-3 p-3 d-flex justify-content-end">
			<c:choose>
